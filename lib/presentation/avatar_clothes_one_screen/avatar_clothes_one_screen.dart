...
class AvatarClothesOneScreen extends GetWidget<AvatarClothesOneController> {
  @override
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                          ...
                          margin: getMargin(left: 76, top: 17),
                      ...
                      Container(
                          ...
                          child: Stack(alignment: Alignment.topLeft, children: [
                            ...
                            CustomButton(
                                ...
                                variant: ButtonVariant.FillAmber100,
                                fontStyle: ButtonFontStyle.CantarellRegular14,
                                alignment: Alignment.topLeft),
                            CustomButton(
                                height: getVerticalSize(30),
                                width: getHorizontalSize(76),
                                text: "lbl_60kg".tr,
                                margin: getMargin(left: 89, top: 1),
                                variant: ButtonVariant.FillLightblue50,
                                fontStyle: ButtonFontStyle.CantarellRegular14,
                                alignment: Alignment.topLeft),
                            CustomImageView(
                            ...
                            CustomImageView(
                                imagePath: ImageConstant.imgAvatar381,
                            ...
                            Align(
                                ...
                                child: Card(
                                    ...
                                    elevation: 0,
                                    margin: getMargin(left: 34, top: 55),
                            ...
                            Align(
                                ...
                                child: Card(
                                    clipBehavior: Clip.antiAlias,
                                    elevation: 0,
                                    margin: getMargin(left: 34, bottom: 113),
                                    color: ColorConstant.amber10001,
                                    shape: RoundedRectangleBorder(
                                        borderRadius:
                                            BorderRadiusStyle.circleBorder30),
                            ...
                            Align(
                                ...
                                child: Container(
                                    ...
                                    decoration: AppDecoration.fillAmber10001,
                                    child: Column(
                                        mainAxisSize: MainAxisSize.min,
                                        mainAxisAlignment:
                                            MainAxisAlignment.start,
                            ...
                            Align(
                                ...
                                child: Container(
                                    height: getSize(65),
                                    width: getSize(65),
                                    margin: getMargin(left: 33, top: 55),
                                    decoration: BoxDecoration(
                            ...
                            Align(
                                ...
                                child: Container(
                                    height: getSize(15),
                                    width: getSize(15),
                                    margin: getMargin(top: 31, right: 80),
                                    decoration: BoxDecoration(
